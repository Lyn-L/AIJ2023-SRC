...
def PreActResNet18_100(num_classes=100, normalize = False, normalize_only_FN = False, scale = 15, activation='ReLU', softplus_beta=1):
    return PreActResNet(PreActBlock, [2,2,2,2], num_classes=num_classes, normalize = normalize
        , normalize_only_FN = normalize_only_FN, scale = scale, activation=activation, softplus_beta=softplus_beta)
...
def PreActResNet34(num_classes=10, normalize = False, normalize_only_FN = False, scale = 15, activation='ReLU', softplus_beta=1):
    return PreActResNet(PreActBlock, [3,4,6,3], num_classes=num_classes, normalize = normalize
        , normalize_only_FN = normalize_only_FN, scale = scale, activation=activation, softplus_beta=softplus_beta)

# def PreActResNet50():
#     return PreActResNet(PreActBottleneck, [3,4,6,3])

def PreActResNet50(num_classes=10, normalize = False, normalize_only_FN = False, scale = 15, activation='ReLU', softplus_beta=1):
    return PreActResNet(PreActBottleneck, [3,4,6,3], num_classes=num_classes, normalize = normalize
        , normalize_only_FN = normalize_only_FN, scale = scale, activation=activation, softplus_beta=softplus_beta)

def PreActResNet50_100(num_classes=10, normalize = False, normalize_only_FN = False, scale = 15, activation='ReLU', softplus_beta=1):
    return PreActResNet(PreActBottleneck, [3,4,6,3], num_classes=num_classes, normalize = normalize
        , normalize_only_FN = normalize_only_FN, scale = scale, activation=activation, softplus_beta=softplus_beta)
...
def PreActResNet101(num_classes=10, normalize = False, normalize_only_FN = False, scale = 15, activation='ReLU', softplus_beta=1):
    return PreActResNet(PreActBottleneck, [3,4,23,3], num_classes=num_classes, normalize = normalize
        , normalize_only_FN = normalize_only_FN, scale = scale, activation=activation, softplus_beta=softplus_beta)
